...
{
    [TestClass]
    public class TransactionCreateViewModelTest
    {
        ...
        [TestMethod]
        public void ConstructorWithActiveAccountTest()
        {

            var viewModel = new TransactionCreateViewModel(_storages, _additionalAccount);
            ...
            Assert.IsNotNull(viewModel.Accounts);
            Assert.IsNotNull(viewModel.Transactions);
            Assert.AreEqual(_additionalAccount, viewModel.Account);
        }
